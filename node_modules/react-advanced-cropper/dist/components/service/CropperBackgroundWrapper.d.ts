...
export declare const CropperBackgroundWrapper: ({ scaleImage, moveImage, rotateImage, children, className, style, cropper, timeout, }: CropperBackgroundWrapperProps) => JSX.Element;
export {};
